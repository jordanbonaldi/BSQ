...
** Last update Sun Dec 18 16:45:18 2016 Bonaldi Jordan
*/
...
static void	set_connection(t_client *cl)
{
  if (connect(cl->fd, (struct sockaddr *)
	      &cl->local, sizeof(struct sockaddr)) < 0)
